...
const authCards = [
  [
    "01 / password",
    "Two different jobs",
    "bcrypt cost 12 checks the login secret. Argon2id separately derives a KEK for Vault unlocking; the password hash is not an encryption key.",
  ],
  [
    "02 / sessions",
    "Bounded lifetime",
    "Encrypted PHP sessions use HttpOnly, SameSite=Lax and strict mode, with a 45-minute idle limit and a 12-hour absolute ceiling.",
  ],
  [
    "03 / rotation",
    "Activity, not polling",
    "Meaningful browser activity renews and rotates the native session identifier. Admin resets can revoke all existing sessions through a version counter.",
  ],
  [
    "04 / second factor",
    "TOTP-ready",
    "Accounts can be required to complete TOTP setup and challenge before ordinary application access is granted.",
  ],
  [
    "05 / mutations",
    "CSRF + ownership",
    "State-changing APIs require an authenticated role, a valid CSRF token and domain-specific ownership or permission checks.",
  ],
  [
    "06 / operations",
    "Short-lived signed access",
    "Runtime WebSockets use Ed25519-signed JWTs with issuer, audience, role, subject and a maximum default lifetime of five minutes.",
  ],
] as const;
...
const uploadFlow = [
  ...
  [
    "02",
    "Name",
    "Filenames are sanitized; dangerous names and unsupported aliases are rejected.",
  ],
  [
    "03",
    "Inspect",
    "Extension, MIME, magic bytes and structured Office/iWork containers must agree.",
  ],
  [
    "04",
    "Scan",
    "When ClamAV is enabled, unavailable or suspicious scans fail closed.",
  ],
  [
    "05",
    "Encrypt",
    "The file becomes a chunked EFR1 XChaCha20 secretstream outside the web root.",
  ],
  [
    "06",
    "Index",
    "Local readers extract bounded text; the local Spark produces embeddings.",
  ],
  [
    "07",
    "Protect",
    "Extracted chunks and embeddings return to encrypted relational storage.",
  ],
] as const;
...
const renderingCards = [
  [
    "01 / math",
    "KaTeX, locally bundled",
    "Mathematical notation is rendered from text without loading an external runtime.",
  ],
  [
    "02 / charts",
    "Constrained JSON",
    "Chart types and values come through a bounded data contract rather than generated executable code.",
  ],
  [
    "03 / plots",
    "Safe DSL + sandbox",
    "Functions, points, parameters and surfaces are parsed by a controlled DSL; no eval or Function constructor is used.",
  ],
  [
    "04 / chemistry",
    "Local SMILES rendering",
    "Two-dimensional chemical structures use a local renderer with validated textual input.",
  ],
  [
    "05 / HTML preview",
    "Opaque sandbox",
    "Explicit previews run without same-origin access, application cookies or unrestricted network authority.",
  ],
  [
    "06 / CSP",
    "No inline execution",
    "Application behavior and style stay in first-party modules and stylesheets under a centrally managed Content Security Policy.",
  ],
] as const;
...
const cleartextFlow = [
  [
    "01",
    "Unlock",
    "The password-derived KEK unwraps the User-DEK for the authenticated session.",
  ],
  [
    "02",
    "Select",
    "Only data required by the requested view, search, export or model operation is decrypted.",
  ],
  [
    "03",
    "Process",
    "Approved plaintext exists in PHP and the relevant local compute service during the request.",
  ],
  [
    "04",
    "Return",
    "The response reaches the browser; durable content is written back encrypted.",
  ],
  [
    "05",
    "Expire",
    "Request memory and non-persistent buffers are not the canonical record.",
  ],
] as const;
      ...
      <main>
        ...
        <section className={atlas.brightSection}>
          <div className={atlas.split}>
            <div className={atlas.stickyCopy}>
              ...
              <p>
                The pilot interface puts password change, second factor, session
                review and optional recovery setup in one human-facing place.
                Recovery is feature-gated and disabled by default.
              </p>
              <ul className={atlas.annotationList}>
                <li>
                  <span>01</span> Review and revoke active sessions
                </li>
                <li>
                  <span>02</span> Change a password without replacing Vault data
                </li>
                <li>
                  <span>03</span> Configure TOTP where deployment policy
                  requires it
                </li>
                <li>
                  <span>04</span> See recovery readiness without exposing key
                  material
                </li>
              </ul>
            </div>
        ...
        <section className={atlas.blueSection}>
          ...
          <div className={atlas.formulaBand}>
            ...
            <div>
              <code>
                EFR1 ‖ secretstream_header ‖ Σ(lengthᵢ ‖ cipher_chunkᵢ)
              </code>
              <p>
