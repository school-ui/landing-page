      ...
      <main>
        ...
        <section className={styles.manifesto}>
          ...
          <div className={styles.manifestoStatement}>
            ...
            <h2>
              It is a living system of people, trust, knowledge and
              responsibility. The AI should understand that.
            </h2>
          </div>
        ...
        <section className={styles.learningSection}>
          <div className={styles.learningCopy}>
            ...
            <p className={styles.learningLead}>
              A student can move from a question to a plot, from project
              material to reflection, and from an explanation to the next better
              question.
            </p>
        ...
        <section className={styles.hardware} id="architecture">
          ...
          <div className={styles.hardwareGrid}>
            ...
            <div className={styles.hardwareFacts}>
              ...
              <p className={styles.hardwareBody}>
                Inference, embeddings and speech run on the school&apos;s own
                hardware. The web application selects only authorised context
                and keeps the persistent data layer separate from the model
                runtime.
              </p>
            </div>
          </div>
          ...
          <div className={styles.privacyNote}>
            ...
            <p>
              Personal content is encrypted at rest. The authorised prompt
              exists briefly in cleartext only where the local model needs it—on
        ...
        <section className={styles.story} id="story">
          <div className={styles.storyVisual}>
            ...
            />
            <p>
              Editorial illustration based on the project&apos;s collaborative
              team composition; all figures are intentionally anonymous.
            </p>
          </div>
